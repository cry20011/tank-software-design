...
//import ru.mipt.bit.platformer.game.MapObjectController;
...
//
//public class AIMapObjectConroller implements MapObjectController, ObjectAddHandler {
...
//
//    public AIMapObjectConroller(AI ai, int width, int height) {
//        this.ai = ai;
//        this.width = width;
//        this.height = height;
//    }
//
//    @Override
//    public Action nextAction(MapObject object) {
